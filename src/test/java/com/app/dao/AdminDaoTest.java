...
public class AdminDaoTest {
    ...
    public void insertCredential() {
        ...
        byId.setCredential(
            new Credential(
                "ashishact2021",
                new BCryptPasswordEncoder(10).encode("ashish123@"),
                Role.ADMIN
            )
        );
        adminRepo.save(byId);
        ...
        byId2.setCredential(
            new Credential(
                "rishavact2021",
                new BCryptPasswordEncoder(10).encode("rishav123@"),
                Role.ADMIN
            )
        );
        ...
        byId3.setCredential(
            new Credential(
                "abhilashact2021",
                new BCryptPasswordEncoder(10).encode("abhilash123@"),
                Role.ADMIN
            )
        );
        ...
        byId4.setCredential(
            new Credential(
                "nekRanjanact2021",
                new BCryptPasswordEncoder(10).encode("nekranjan123@"),
                Role.ADMIN
            )
        );
        ...
        byId5.setCredential(
            new Credential(
                "chiragact2021",
                new BCryptPasswordEncoder(10).encode("chirag123@"),
                Role.ADMIN
            )
        );
